...
## Application idea
This application streams tweets (in real-time) and iteratively counts the occurrences of individual words. Serving scripts have been written to search for the frequencies of words, filter words by search or occurence counts, and create a bar chart of the top 20 words. 
...
![streamparse topology diagram](C:/Users/jrose/Desktop/top.png)

The tweet spout uses 3 processes and shuffles to the parse-tweet bolt. Parse-tweet bolt uses 3 processes and shuffles to 2 processes of count-bolt which is then pushed to postgres.
